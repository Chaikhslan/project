                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content side-content-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a href="/accaunts"><i class="fa fa-instagram"></i><span class="sidebar-mini-hide">Аккаунты</span></a>
                                </li>
                                <li>
                                                    ...
                                                    <td class="<?= $column['class'] ?>">
                                                        <div class="btn-group" role="group">
                                                            ...
                                                            foreach ($column['buttons'] as $button) {
                                                                echo '<a class="btn btn-default" href="' . $button['route'] . '"><i class="' . $button['icon'] . '"></i></a>';
                                                            }
                                                            ?>
                                                        </div>
                                                    </td>
